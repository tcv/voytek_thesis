...
\textcolor{red}{Note that I haven't put the images in yet since we're still finalizing the video. There's just a single stand in image copied repeatedly for now.}
...
\textit{From early times, photons of light were able to freely travel through the universe. These photons each had a specific wavelength, or color. For some, that wavelength was 21 centimeters, or a little over 8 inches. }& 
...
\textit{As the universe expands, or stretches, the wavelength of the photon also expands and grows longer. We call this expansion redshifting, because red light has longer wavelengths than blue light. }& 
...
\textit{The telescope looks at a different part of the sky in each second. So we build a n image of the sky, one point at a time. }& 
...
\textit{With many recievers along the center line of each cylinder, CHIME collects light from a stripe of the sky instead of a single point. Meanwhile, the rotation of the Earth causes the cylinder to see a slightly different stripe of sky each second.} & 
