...
The final version of the script is laid out below in Table \ref{Tab:script_w_screenshots}. Along with each paragraph of the script is a single image that represents the video corresponding to that paragraph. 
...
\textit{At the Green Bank Telescope, light is captured by a reciever located above the huge dish of the telescope. }& 
...
\textit{With many recievers along the center line of each cylinder, CHIME collects light from a stripe of the sky instead of a single point.}
