...
\caption{Simulated HIbiscus antenna beam, shown for different frequencies at a single azimuthal plane. }
...
\centering
\includegraphics[width=0.95\linewidth]{SCIHI_system/figures/HIbiscus_gain.png}
\caption{Simulated HIbiscus antenna beam, shown for different frequencies at a single azimuth. \textcolor{red}{Add here a simulation image for a different azimuth. Currently showing two images of the same azimuthal plane. }}
...
\paragraph{Impedance} 
Impedance matching is quantified by the antenna S11 parameter, which is measured in comparison to a set impedance ($Z_{ref}= 50 \Omega$). Impedance (Z) is the complex resistance of a circuit element, and is can be calculated relative to S11.  \cite{rogers_2012} 
...
\centering
\includegraphics[width=0.95\linewidth]{SCIHI_system/figures/SCIHI_filter.jpg}
\caption{\textcolor{red}{Still need to take the screenshot of the UI} User interface for the SCI-HI system. }
\label{Fig:GUI}
\end{minipage}%
\begin{minipage}[b]{0.02\textwidth}
\hspace{1cm}
